<x-app-layout>
    <x-slot name="header"> 
    <div class="font-semibold text-xl text-gray-800 leading-tight">{{__('Creación de caracteristica')}}</div >
    ...
    <div class="container mx-auto transform translate-y-6 w-full">
        ...
        <div class="bg-white p-4 border-solid rounded">
                ...
                <tr>
                    <form action="{{ route('caracteristica_i.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    @csrf
                    @method('POST')
